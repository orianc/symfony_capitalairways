 ...
 */
final class Version20210429123455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE city (id INT NOT NULL, name VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE flight (id INT NOT NULL, departure_id INT NOT NULL, arrival_id INT NOT NULL, numero INT NOT NULL, schedule TIME(0) WITHOUT TIME ZONE NOT NULL, price DOUBLE PRECISION NOT NULL, reduction BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
